...
const {isDefined,isUndefined,isObject,isArray,isEmptyArray,isEmptyObject,isNull,isNaN, isActualNaN} = require('@pbbbl/is');
function clean(valueToClean, option={...defaultOptions}):any{
    if(!options){
